...
CREATE TABLE personne (idpersonne bigint NOT NULL, namepersonne varchar(255), passpersonne varchar(255), mailpersonne varchar(255), estAdmin Boolean , nbPoint bigint );
